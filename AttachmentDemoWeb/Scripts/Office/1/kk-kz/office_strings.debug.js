...
Strings.OfficeOM.L_NewWindowCrossZoneConfigureBrowserLink = "браузерді конфигурациялау";
...
Strings.OfficeOM.L_NewWindowCrossZone = 'Браузердегі қауіпсіздік параметрлеріне байланысты диалогтық терезені жасау мүмкін емес. Басқа браузерді немесе {0} пайдаланып көріңіз, сонда мекенжай жолағында көрсетілген "{1}" және домен бір қауіпсіздік аймағында болады.';
...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = '"{0}" сипатына тек оқу үшін режимін орнату әрекеті орындалуда.';
